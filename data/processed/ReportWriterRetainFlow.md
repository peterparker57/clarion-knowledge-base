...
PrintReportW ithDialog(Send Report with Printer Dialog) ...................................................... 204 
...
its own page. 
    Design reports in a W YSIWYG (What You See, Is What You Get) Designer. All of your 
...
Btrieve, Clipper, dBase III & IV, FoxPro, ASCII, BASIC, and DOS. W hen you need to read data 
...
In some file systems the keys are kept in separate disk files, in others they are contained within 
the same file as the data. TopSpeed‘s file driver technology handles these differences 
transparently. 
...
example, if the records are sorted on a date field, you might want to see the most recent record 
first. 
...
To change a condition's operator, invoke the operator list by doing one of the following: 
    ...
    Focus the current operator via the keyboard and press SPACE or ALT+DOW N 
## ARROW
...
Percentage 
Serves a dual purpose. Using the drop list you can instantly modify the 
...
Examples\ReportWriter\REPXL 
Reports\RWTutor\School\Solution. 
...
• Use the Label W izard to create Mailing Labels 
Quick Start Lessons 
...
A group break occurs each time the Course Description field‘s value changes. W ithin that 
...
tab to preview the report. W hen you are 
...
1. RIGHT-CLICK on the Header band, then select Properties. 
...
previous element must print on the same page. W hen placing subtotals or totals in a band, use 
...
Two Groups are shown to the left of the Chart W izard. Pages are displayed just to the right of 
the Groups section. 
To navigate through the Chart W izard's pages, use the navigation bar or Previous and Next 
buttons. 
...
click Add New DataSource. The Report W izard dialog will appear. 
...
2. Include the ClaPRLB.LIB library in your project (or C%V%prlb%X%.lib to include a 
generic reference that will work in future versions of Clarion). 
 
3. Create a configuration XML file. The name of the configuration file is the name of the app 
with a .config extension. For example, an app called myApp.exe should have a source 
configuration file called myApp.exe.config. Put the following text into the config file: 
...
UsePrinterDialog (W hen PrintReport is called the Printer Selection Dialog is displayed) 
...
Create a configuration XML file. The name of the configuration file is the name of the app with a 
.config extension. For example, an app called myApp.exe should have a source configuration 
file called myApp.exe.config. Put the following text into the config file: 
...
PrintReportW ithDialog(Send Report with Printer Dialog) 
...
printerdef 
The printer name (device) as defined in the W indows Print Manager. 
...
This will open up the Data Source dialog that you see when using the Report W izard. You can 
...
Size 
The total number of digits, plus any formatting characters. For example, 
...
panel. 
Windows Long 
Uses the long date format specified in W indows Control Panel or Regional Settings control 
panel. 
...
character). The space character is neither true nor false. W hen using a logical field from a 
...
space character). The space character is neither true nor false. W hen using a logical field from 
...
all your W indows applications. Yet, when deciding whether to use an ODBC driver or a Clarion 
...
Microsoft setup program places in the \W indows\System directory. This is the ODBC 
...
## DECIMAL
## DECIMAL,
## BYTE1,SHORT1,LONG1,PDECIMAL
## NUMERIC
## PDECIMAL,
## BYTE1,SHORT1,LONG1,DECIMAL
## SMALLINT
## SHORT
## INTEGER
## LONG
...
structure. W hen the value in the field changes while sequentially 
...
object. W hen drag and drop is supported by the program(s), the action 
...
formatting for a report in "WYSIW YG" fashion. 
function 
...
INI file 
A W indows Initialization file in ASCII format. The .INI file is divided into 
...
"Cancel," and "Retry." 
metafile 
In W indows, the representation of a graphic or line art in vector (device 
...
It also creates Shortcuts on the Start Menu for the ReportWriter and documentation. 
...
PrintReport print a report ......................... 150 
PrintReport Send Report to Printer .......... 203 
PrintReportW ithDialog Send Report with 
Printer Dialog ....................................... 204 
...
ResolveVariableFilename Specify value for a 
variable filename.................................. 172 
